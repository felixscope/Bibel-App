...
export function DailyVerse() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20">
        {/* Background Image */}
        ...
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-black/30 via-black/20 to-black/30" />
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white/90
