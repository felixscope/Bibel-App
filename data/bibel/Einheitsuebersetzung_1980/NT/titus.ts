...
export const titus: Book = {
  ...
  chapters: [
    { number: 1, verses: [
      { number: 1, text: "Bekenntnis, Anschrift und Gruß: 1,1-41 Paulus, Knecht Gottes und Apostel Jesu Christi, berufen, um die Auserwählten Gottes zum Glauben und zur Erkenntnis der wahren Gottesverehrung zu führen,", footnotes: ["1 Tim 2,4; 2 Tim 3,7"] },
      ...
      { number: 5, text: "Die Aufgaben des Titus: 1,5 - 3,11Einsetzung geeigneter Vorsteher: 1,5-95 Ich habe dich in Kreta deswegen zurückgelassen, damit du das, was noch zu tun ist, zu Ende führst und in den einzelnen Städten Älteste einsetzt, wie ich dir aufgetragen habe.", footnotes: ["Apg 14,23; 1 Tim 3,2-4"] },
      { number: 6, text: "Ein Ältester soll unbescholten und nur einmal verheiratet sein. Seine Kinder sollen gläubig sein; man soll ihnen nicht nachsagen können, sie seien liederlich und ungehorsam.", heading: "Einsetzung geeigneter Vorsteher: 1,5-9", footnotes: ["Apg 20,17.28; 1 Petr 5,2f", "6f: Zu «Ältester» und «Bischof» vgl. die Anmerkung zu 1 Tim 3,1. Zu «nur einmal verheiratet» vgl. die Anmerkung zu 1 Tim 3,2."] },
      ...
      { number: 10, text: "Bekämpfung der Irrlehrer: 1,10-1610 Denn es gibt viele Ungehorsame, Schwätzer und Schwindler, besonders unter denen, die aus dem Judentum kommen." },
    ...
    { number: 2, verses: [
      { number: 1, text: "Anweisungen für einzelne Stände: 2,1-101 Du aber verkünde, was der gesunden Lehre entspricht.", footnotes: ["1,9; 2,10; 1 Tim 1,10; 4,6; 6,3; 2 Tim 1,13; 4,3"] },
      { number: 2, text: "Die älteren Männer sollen nüchtern sein, achtbar, besonnen, stark im Glauben, in der Liebe, in der Ausdauer.", heading: "Anweisungen für einzelne Stände: 2,1-10", footnotes: ["stark im Glauben, wörtlich: gesund im Glauben."] },
      ...
      { number: 11, text: "Gnade und christliches Leben: 2,11-1511 Denn die Gnade Gottes ist erschienen, um alle Menschen zu retten.", footnotes: ["3,4", "11-14: Hier und in 3,3-7 werden Formulierungen aus der urchristlichen Taufliturgie aufgenommen. Als Beginn einer liturgischen Lesung wird folgende Fassung vorgeschlagen: Erschienen ist die Gnade Gottes."] },
    ...
    { number: 3, verses: [
      { number: 1, text: "Die Pflichten der Getauften im sozialen Bereich: 3,1-81 Erinnere sie daran, sich den Herrschern und Machthabern unterzuordnen und ihnen zu gehorchen. Sie sollen immer bereit sein, Gutes zu tun,", footnotes: ["Röm 13,1-7; 1 Petr 2,13-17"] },
      ...
      { number: 9, text: "Erneute Warnung vor Irrlehrern: 3,9-119 Lass dich nicht ein auf törichte Auseinandersetzungen und Erörterungen über Geschlechterreihen, auf Streit und Gezänk über das Gesetz; sie sind nutzlos und vergeblich.", footnotes: ["1 Tim 1,4"] },
      { number: 10, text: "Wenn du einen Sektierer einmal und ein zweites Mal ermahnt hast, so meide ihn.", heading: "Erneute Warnung vor Irrlehrern: 3,9-11", footnotes: ["Mt 18,15-17"] },
      { number: 11, text: "Du weißt, ein solcher Mensch ist auf dem verkehrten Weg; er sündigt und spricht sich selbst das Urteil." },
      { number: 12, text: "Der Schluss des Briefes: persönliche Mitteilungen und Grüße: 3,12-1512 Sobald ich Artemas oder Tychikus zu dir schicke, komm rasch zu mir nach Nikopolis; denn ich habe mich entschlossen, dort den Winter zu verbringen.", footnotes: ["2 Tim 4,12"] },
