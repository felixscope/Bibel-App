...
export const titus: Book = {
  ...
  chapters: [
    { number: 1, verses: [
      ...
      { number: 5, text: "Ich habe dich in Kreta deswegen zurückgelassen, damit du das, was noch zu tun ist, zu Ende führst und in den einzelnen Städten Älteste einsetzt, wie ich dir aufgetragen habe. *", heading: "Die Aufgaben des Titus: 1,5 - 3,11\nEinsetzung geeigneter Vorsteher: 1,5-9", footnotes: ["℘ Apg 14,23; 1 Tim 3,2-4"] },
      { number: 6, text: "Ein Ältester soll unbescholten und nur einmal verheiratet sein. Seine Kinder sollen gläubig sein; man soll ihnen nicht nachsagen können, sie seien liederlich und ungehorsam. **", footnotes: ["℘ Apg 20,17.28; 1 Petr 5,2f\n\n6f: Zu «Ältester» und «Bischof» vgl. die Anmerkung zu 1 Tim 3,1. Zu «nur einmal verheiratet» vgl. die Anmerkung zu 1 Tim 3,2."] },
    ...
    { number: 2, verses: [
      ...
      { number: 11, text: "Denn die Gnade Gottes ist erschienen, um alle Menschen zu retten. **", heading: "Gnade und christliches Leben: 2,11-15", footnotes: ["℘ 3,4\n\n11-14: Hier und in 3,3-7 werden Formulierungen aus der urchristlichen Taufliturgie aufgenommen. Als Beginn einer liturgischen Lesung wird folgende Fassung vorgeschlagen: Erschienen ist die Gnade Gottes."] },
      ...
      { number: 13, text: "während wir auf die selige Erfüllung unserer Hoffnung warten: auf das Erscheinen der Herrlichkeit unseres großen Gottes und Retters Christus Jesus. **", footnotes: ["℘ 1,4\n\nAndere Übersetzungsmöglichkeit: der Herrlichkeit des großen Gottes und unseres Retters Christus Jesus."] },
