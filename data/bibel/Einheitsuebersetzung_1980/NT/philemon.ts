...
export const philemon: Book = {
  ...
  chapters: [
    { number: 1, verses: [
      ...
      { number: 2, heading: "Anschrift und Gruß: 1-3", text: "an die Schwester Aphia, an Archippus, unseren Mitstreiter, und an die Gemeinde in deinem Haus:", footnotes: ["Kol 4,17"] },
      ...
      { number: 5, heading: "Dankgebet des Apostels: 4-7", text: "Denn ich höre von deinem Glauben an Jesus, den Herrn, und von deiner Liebe zu allen Heiligen." },
      ...
      { number: 9, heading: "Fürsprache für Onesimus: 8-20", text: "ziehe ich es um der Liebe willen vor, dich zu bitten. Ich, Paulus, ein alter Mann, der jetzt für Christus Jesus im Kerker liegt," },
      ...
      { number: 22, heading: "Grüße und Segen: 21-25", text: "Bereite zugleich eine Unterkunft für mich vor! Denn ich hoffe, dass ich euch durch eure Gebete wiedergeschenkt werde." },
