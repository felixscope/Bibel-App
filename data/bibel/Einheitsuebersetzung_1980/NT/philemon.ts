...
export const philemon: Book = {
  ...
  chapters: [
    { number: 1, verses: [
      { number: 1, text: "Paulus, Gefangener Christi Jesu, und der Bruder Timotheus an unseren geliebten Mitarbeiter Philemon," },
      { number: 2, text: "an die Schwester Aphia, an Archippus, unseren Mitstreiter, und an die Gemeinde in deinem Haus: 1", heading: "Anschrift und Gruß: 1-3" },
      { number: 3, text: "Gnade sei mit euch und Friede von Gott, unserem Vater, und dem Herrn Jesus Christus. 2" },
      ...
      { number: 10, text: "ich bitte dich für mein Kind Onesimus, dem ich im Gefängnis zum Vater geworden bin. 3" },
      ...
      { number: 16, text: "nicht mehr als Sklaven, sondern als weit mehr: als geliebten Bruder. Das ist er jedenfalls für mich, um wie viel mehr dann für dich, als Mensch und auch vor dem Herrn. 4" },
      ...
      { number: 19, text: "Ich, Paulus, schreibe mit eigener Hand: Ich werde es bezahlen - um nicht davon zu reden, dass du dich selbst mir schuldest. 5" },
      ...
      { number: 23, text: "Es grüßen dich Epaphras, der mit mir um Christi Jesu willen im Gefängnis ist, 6" },
      { number: 24, text: "sowie Markus, Aristarch, Demas und Lukas, meine Mitarbeiter." },
      { number: 25, text: "Die Gnade Jesu Christi, des Herrn, sei mit eurem Geist! 7" },
    ] },
  ],
};
